...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/enping/boids/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/enping/boids/src/build/devel)
...
if(NOT "/home/enping/boids/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/enping/boids/src/geometry/eigen_conversions/include;/usr/include/eigen3;/opt/ros/melodic/share/orocos_kdl/cmake/../../../include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/enping/boids/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
