...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/enping/boids/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/enping/boids/src/build/devel)
...
if(NOT "/home/enping/boids/src/cv_camera/include;/usr/include;/usr/include/opencv " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/enping/boids/src/cv_camera/include;/usr/include;/usr/include/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/enping/boids/src/cv_camera/${idir}'.  ${_report}")
    endif()
