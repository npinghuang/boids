...
if("TRUE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /home/enping/boids/src/image_pipeline/image_publisher)
...
if(NOT "/home/enping/boids/src/build/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/enping/boids/src/image_pipeline/image_publisher/${idir}'.  ${_report}")
    endif()
